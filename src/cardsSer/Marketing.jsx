    ...
    <div>
        <header id="site-header" className="fixed-top">
            ...
            <div className="financial-container">
                <img className="financ" src="./assets/images/bg1.jpg" alt="" />
                <div className='both'>
                <h3 className='fi'>learn your business with us</h3>
                <h1 className="fin">Marketing Services</h1>
                </div>
            </div>
            <div class="row justify-content-center">
                ...
                <div class="col-lg-4 col-md-6 mt-md-0 mt-4">
                    ...
                    <div class="icon">
                        ...
                        <h4><a href="#url">Content Marketing</a></h4>
                        <p> Creating valuable content (blogs, videos, infographics) 
                            to engage customers and establish authority.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mt-lg-0 mt-4">
                    ...
                    <div class="icon">
                        ...
                        <p>Creating a strong brand identity through logos, messaging , 
                            and positioning strategies.</p>
                ...
                <div class="col-lg-4 col-md-6 mt-4">
                    ...
                    <div class="icon">
                        ...
                        <h4><a href="#url">Market Research</a></h4>
                        <p>  Analyzing market trends, customer behavior, and competition 
                            to inform marketing strategies. this is Market Research</p>
                ...
                <div class="col-lg-4 col-md-6 mt-4">
                    ...
                    <div class="icon">
                        ...
                        <h4><a href="#url">Advertising</a></h4>
                        <p>  Developing and executing advertising campaigns across various media, both online and offline .</p>
