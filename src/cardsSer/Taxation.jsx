    ...
    <div>
        <header id="site-header" className="fixed-top">
            ...
            <div className="financial-container">
                ...
                <h1 className="fin">Taxation Services</h1>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="box-wrap">
                        ...
                        <h4><a href="#url">Tax Preparation</a></h4>
                        <p>Preparing and filing tax returns accurately and on time 
                ...
                <div class="col-lg-4 col-md-6 mt-md-0 mt-4">
                    ...
                    <div class="icon">
                        ...
                        <h4><a href="#url">Tax Planning</a></h4>
                        <p> Developing strategies to minimize tax liabilities through 
                            deductions,credits, and other strategies.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mt-lg-0 mt-4">
                    ...
                    <div class="icon">
                        ...
                        <p>Providing advice on tax-related matters, including compliance
                             and potential audits.</p>
                ...
                <div class="col-lg-4 col-md-6 mt-4">
                    ...
                    <div class="icon">
                        ...
                        <h4><a href="#url">Corporate Tax Services</a></h4>
                        <p>  Helping  businesses  manage  their  tax obligations,
                           including  payroll  taxes  and sales tax . " Tax Services "</p>
                ...
                <div class="col-lg-4 col-md-6 mt-4">
                    ...
                    <div class="icon">
                        ...
                        <h4><a href="#url">International Taxation</a></h4>
                        <p> Assisting clients with cross-border tax issues, 
                            including expatriate tax planning and compliance.</p>
